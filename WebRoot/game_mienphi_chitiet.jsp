...
<html>
	<head>
		<title>Java Game | Game dien thoai | <%=game.getName() %></title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta name="description" content="Java game Miễn phí dành cho điện thoại di động, game <%=game.getName() %>">
			...
			<div style="width:960px; ">
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<td width="5"></td>
					<td valign="top">
						<jsp:include flush="true" page="game_mienphi_chitiet_trong.jsp">
