...
<%@ page import="inet.webservice.krazevina.*"%>
<%@ page import="java.math.*"%>
<jsp:useBean id="krazeGameDAO" class="inet.webservice.krazevina.KrazeGameListDAO" scope="session" />
<%
	KrazeGameList game=krazeGameDAO.getGame(new BigDecimal(115));
%>
				  ...
				  <tr>
					...
					<td valign="top">
						...
						<div class="noidungchitiet" style="padding-top:20px; ">
							...
							<img src="/images/game-kim-cuong.gif" align="right" class="boder-pic" alt="Java game: <%=game.getName() %>" title="Java game: <%=game.getName() %>">
							<br>
							<strong>Mã số:</strong> 96115
							</div>
						...
						<img src="<%=request.getContextPath() %>/images/gamemobile-bannerhuongdanGPRS.gif" align="right" border="0"></a>
						  ...
						  <p><strong>GAME 96115 </strong>gửi <strong>8785 </strong></p>
						  <p>Để gửi cho bạn b&egrave; soạn tin: </p>
						  <p><strong>GAME 96115 SĐTnhận </strong> gửi <strong>8785</strong> </p>
