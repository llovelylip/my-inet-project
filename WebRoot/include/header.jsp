...
<%
	...
	//Kiểm tra người dùng truy cập từ Mobile or PC
	...
	IMNick imNick = null;
	if (session.getAttribute("INET_CHAT_USER") != null) {
		imNick = (IMNick) session.getAttribute("INET_CHAT_USER");
	}	
	
	//imNick = new IMNick();
	//imNick.setNickname("lovethe");
	
%>
	
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<link rel="icon" href="<%=request.getContextPath() %>/images/icon-wap.ico" type="image/x-icon" />
	<link href="<%=request.getContextPath() %>/include/style.css" rel="stylesheet" type="text/css">
	<center>
		<div id="top"><img src="<%=request.getContextPath() %>/images/logo-top.jpg"></div>
	</center>
