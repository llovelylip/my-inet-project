...
public class GameCategoryDAO {
    ...
    public boolean insertRow(String name, BigDecimal parentId, int groupId, int indentLevel, int status) {
        ...
        try {
            ...
            strSQL =
                "INSERT INTO GAME_CATEGORY (ID, NAME, PARENT_ID, GROUP_ID, INDENT_LEVEL, STATUS) " +
                "VALUES (GAME_CATEGORY_SEQ.nextval, ?, ?, ?, ?, ?)";
    ...
    public boolean deleteRow(BigDecimal id) {
        ...
        try {
            conn = poolX.getConnection();
            strSQL =
                "delete from GAME_CATEGORY where ID = ?";
            preStmt = conn.prepareStatement(strSQL);
    ...
    public GameCategory getRow(BigDecimal id) {
        Connection conn = null;
        PreparedStatement preStmt = null;
        ResultSet rs = null;
        String strSQL = null;
    ...
    public boolean updateRow(GameCategory cat) {
        if (cat == null) {
        ...
        try {
            conn = poolX.getConnection();
            strSQL =
                "UPDATE GAME_CATEGORY SET NAME = ?, PARENT_ID = ?, STATUS = ?,LAST_UPDATED=SYSDATE " +
                "WHERE ID = ?";
            preStmt = conn.prepareStatement(strSQL);
    ...
    public Collection findAllRoots() {
        ...
        try {
            ...
            strSQL =
                "SELECT ID, NAME, PARENT_ID, GROUP_ID, INDENT_LEVEL, STATUS " +
                "FROM GAME_CATEGORY WHERE PARENT_ID = 0";
            preStmt = conn.prepareStatement(strSQL);
            rs = preStmt.executeQuery();
            result = new Vector();
            GameCategory cat = null;
    ...
    public Collection findAllRoots(int status) {
        ...
        try {
            ...
            strSQL =
                "SELECT ID, NAME, PARENT_ID, GROUP_ID, INDENT_LEVEL, STATUS " +
                "FROM GAME_CATEGORY WHERE PARENT_ID = 0 AND STATUS = ?";
            preStmt = conn.prepareStatement(strSQL);
    ...
    public Collection findByParentId(BigDecimal parentId) {
        ...
        try {
            ...
            strSQL =
                "SELECT ID, NAME, PARENT_ID, GROUP_ID, INDENT_LEVEL, STATUS " +
                "FROM GAME_CATEGORY WHERE PARENT_ID = ?";
            preStmt = conn.prepareStatement(strSQL);
    ...
    public Collection findByParentId(BigDecimal parentId, int status) {
        ...
        try {
            ...
            strSQL =
                "SELECT ID, NAME, PARENT_ID, GROUP_ID, INDENT_LEVEL, STATUS " +
                "FROM GAME_CATEGORY WHERE PARENT_ID = ? AND STATUS = ?";
            preStmt = conn.prepareStatement(strSQL);
            preStmt.setBigDecimal(1, parentId);
            preStmt.setInt(1, status);
            rs = preStmt.executeQuery();
    ...
    public int getNewGroupId() {
        ...
        try {
            conn = poolX.getConnection();
            strSQL =
                "SELECT MAX(GROUP_ID) FROM GAME_CATEGORY";
            preStmt = conn.prepareStatement(strSQL);
            rs = preStmt.executeQuery();
            if (rs.next()) {
                groupId = rs.getInt(1);
    ...
    public int getCountChidren(BigDecimal id) {
        ...
        try {
            conn = poolX.getConnection();
            strSQL =
                "SELECT COUNT(*) FROM GAME_CATEGORY WHERE PARENT_ID = ?";
            preStmt = conn.prepareStatement(strSQL);
            preStmt.setBigDecimal(1, id);
            rs = preStmt.executeQuery();
            if (rs.next()) {
