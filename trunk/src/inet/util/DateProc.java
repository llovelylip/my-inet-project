...
public class DateProc {
    ...
    public static String Calendar2DDMMYYYY(Calendar calendar) {
        if (calendar == null) {
            return "";
        } else {
             String strTemp = Integer.toString(calendar.get(calendar.
    ...
    public static String Timestamp2HHMMSSHaveSeperator(java.sql.Timestamp ts) {
        if (ts == null)
            return "";
    ...
    public static String Calendar2HHMMSS(Calendar calendar,int iStyle) {
        if (calendar == null)
            return "";
    ...
    public static String Timestamp2String(Timestamp ts){
    	java.util.Calendar calendar = java.util.Calendar.getInstance();
        calendar.setTime(new java.util.Date(ts.getTime()-60*1000));
        return DateProc.Calendar2DDMMYYYY(calendar)+" "+DateProc.Calendar2HHMMSS(calendar,0); 
    }
